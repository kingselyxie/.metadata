...
%>
<%try{	
	String username = new String(request.getParameter("reallyname"));
    ...
    IsSucceed = Jobseeker.Modify(username,name,sex,nativeplace,marriage,identityid,politics,folk,education,department,university,
			foreignlanguage,fllevel,computerlevel,phone,mobilephone,address,resume,birthday,graduatedate);
