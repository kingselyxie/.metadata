...
<td align="center" width="100">Job positon<br></td><td><%=DataConvert.ViewStr(job.getPost())%></td>
</tr>
<tr>
<td align="center" width="100">Department<br></td><td><%=DataConvert.ViewStr(job.getBranch())%></td>
</tr>
<tr>
<td align="center" width="100">Number<br></td><td><%=job.getMannumber()%></td>
</tr>
<tr>
...
<tr>
<td align="center" width="100">Job Requriement<br></td><td><%=DataConvert.ViewStr(job.getResume1())%></td>
