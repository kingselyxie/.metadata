...
%>
<%try{	
	String price1 = new String(request.getParameter("price"));
	double price=Double.parseDouble(price1);
	String isorno= new String(request.getParameter("isorno"));
	String usermes = new String(request.getParameter("usermes"));
	String rtime = new String(request.getParameter("rtime"));
	
    IsSucceed = Room.Modify(roomid,price,isorno,usermes,rtime);
...
<table width="844" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	if(IsSucceed.equals("1"))
		out.println("修改房间信息成功！");
	else
	{
		out.println("修改房间信息失败!");	
  %>
        <br>
        <%		
  ...
  %>
      ...
      <form name="form2" method="post" action="ManageRoom.jsp">
