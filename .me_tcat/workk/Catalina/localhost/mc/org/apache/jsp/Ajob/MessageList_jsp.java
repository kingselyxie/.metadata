  ...
  if((String)session.getValue("IsLogin")!="true")
   {
	...
	Vector listemployee=Jobseeker.ListAll();
	 Vector jobList=Job.ListAll();
      ...
      out.write("{\r\n");
      out.write("if (confirm(\"真的要删除员工编号为 \"+a+\" 的人员档案吗?\") )\r\n");
      ...
      out.write("\t<p align=\"center\" class=\"title1\">Recruitment member management<br></p>\r\n");
      ...
      out.write("        <td width=\"66\"><div align=\"center\">Job interview</div></td>\r\n");
      out.write("        <td width=\"66\"><div align=\"center\">Department</div></td>\r\n");
      out.write("        <td></td>\r\n");
      out.write("      </tr>\r\n");
      out.write(" ");
      ...
      out.write("</div></td>\r\n");
      out.write("       <td><div align=\"center\"><a href=\"MJob.jsp?username=");
      out.print(employee.getUserName());
      out.write("\">符合要求</a></div></td>\r\n");
      out.write("\t  </tr>\r\n");
